...
static const prometheus_kpi_descriptor prometheus_kpi_proc_meminfo[] = {
    ...
    { "proc_meminfo_Percpu", KPI_TYPE::Gauge, "" },
    ...
    { "proc_meminfo_AnonHugePages", KPI_TYPE::Gauge,
        ...
        "userspace page tables" },
    { "proc_meminfo_CmaTotal", KPI_TYPE::Gauge, "" },
    { "proc_meminfo_CmaFree", KPI_TYPE::Gauge, "" },
    ...
    { "proc_meminfo_DirectMap1G", KPI_TYPE::Gauge, "" },
};

static const prometheus_kpi_descriptor prometheus_kpi_proc_vmstat[] = {
    // baremetal: proc_vmstat
    { "proc_vmstat_allocstall", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_balloon_deflate", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_balloon_inflate", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_balloon_migrate", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_compact_fail", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_compact_free_scanned", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_compact_isolated", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_compact_migrate_scanned", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_compact_stall", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_compact_success", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_drop_pagecache", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_drop_slab", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_htlb_buddy_alloc_fail", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_htlb_buddy_alloc_success", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_kswapd_high_wmark_hit_quickly", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_kswapd_inodesteal", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_kswapd_low_wmark_hit_quickly", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_active_anon", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_active_file", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_alloc_batch", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_anon_pages", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_anon_transparent_hugepages", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_bounce", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_dirtied", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_dirty", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_dirty_background_threshold", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_dirty_threshold", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_file_pages", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_free_cma", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_free_pages", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_inactive_anon", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_inactive_file", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_isolated_anon", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_isolated_file", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_kernel_stack", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_mapped", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_mlock", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_page_table_pages", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_shmem", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_slab_reclaimable", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_slab_unreclaimable", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_unevictable", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_unstable", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_vmscan_immediate_reclaim", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_vmscan_write", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_writeback", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_writeback_temp", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_nr_written", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_numa_foreign", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_numa_hint_faults", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_numa_hint_faults_local", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_numa_hit", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_numa_huge_pte_updates", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_numa_interleave", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_numa_local", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_numa_miss", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_numa_other", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_numa_pages_migrated", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_numa_pte_updates", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pageoutrun", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgactivate", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgalloc_dma", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgalloc_dma32", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgalloc_movable", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgalloc_normal", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgdeactivate", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgfault", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgfree", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pginodesteal", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pglazyfreed", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgmajfault", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgmigrate_fail", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgmigrate_success", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgpgin", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgpgout", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgrefill_dma", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgrefill_dma32", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgrefill_movable", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgrefill_normal", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgrotated", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgscan_direct_dma", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgscan_direct_dma32", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgscan_direct_movable", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgscan_direct_normal", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgscan_direct_throttle", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgscan_kswapd_dma", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgscan_kswapd_dma32", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgscan_kswapd_movable", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgscan_kswapd_normal", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgsteal_direct_dma", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgsteal_direct_dma32", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgsteal_direct_movable", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgsteal_direct_normal", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgsteal_kswapd_dma", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgsteal_kswapd_dma32", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgsteal_kswapd_movable", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pgsteal_kswapd_normal", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pswpin", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_pswpout", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_slabs_scanned", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_swap_ra", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_swap_ra_hit", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_thp_collapse_alloc", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_thp_collapse_alloc_failed", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_thp_fault_alloc", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_thp_fault_fallback", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_thp_split", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_thp_zero_page_alloc", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_thp_zero_page_alloc_failed", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_unevictable_pgs_cleared", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_unevictable_pgs_culled", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_unevictable_pgs_mlocked", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_unevictable_pgs_munlocked", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_unevictable_pgs_rescued", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_unevictable_pgs_scanned", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_unevictable_pgs_stranded", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_workingset_activate", KPI_TYPE::Gauge, "" },
    { "proc_vmstat_workingset_nodereclaim", KPI_TYPE::Gauge, "" },
