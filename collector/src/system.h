...
static const prometheus_kpi_descriptor g_prometheus_kpi_disk[] = {
    // baremetal : disk
    { "disks_reads", prometheus::MetricType::Counter, "total reads completed successfully" },
    { "disks_rmerge", prometheus::MetricType::Counter, "total reads merged" },
    { "disks_rkb", prometheus::MetricType::Counter, "total number of sectors read from disk" },
    { "disks_rmsec", prometheus::MetricType::Counter, "total time spent reading (ms)" },
    { "disks_writes", prometheus::MetricType::Counter, "total writes completed successfully" },
    { "disks_wmerge", prometheus::MetricType::Counter, "total writes merged" },
    { "disks_wmsec", prometheus::MetricType::Counter, "total time spent writting (ms)" },
    { "disks_wkb", prometheus::MetricType::Counter, "total number of sectors writeen to disk" },
    { "disks_inflight", prometheus::MetricType::Counter, "I/Os currently in progress" },
    { "disks_time", prometheus::MetricType::Counter, "time spent doing I/Os (ms)" },
    { "disks_backlog", prometheus::MetricType::Counter, "weighted time spent doing I/Os (ms)" },
    { "disks_xfers", prometheus::MetricType::Counter, "total reads/writes in Kbyte" },
    { "disks_bsize", prometheus::MetricType::Counter, "total I/Os in Kbyte" },
};

static const prometheus_kpi_descriptor g_prometheus_kpi_network[] = {
    // baremetal : network
    { "network_interfaces_ibytes", prometheus::MetricType::Counter,
        "total number of bytes of data received by the interface" },
    { "network_interfaces_ipackets", prometheus::MetricType::Counter,
        "total number of packets of data received by the interface" },
    { "network_interfaces_ierrs", prometheus::MetricType::Counter,
        "total number of receive errors detected by the device driver" },
    { "network_interfaces_idrop", prometheus::MetricType::Counter,
        "total number of packets dropped by the device driver" },
    { "network_interfaces_ififo", prometheus::MetricType::Counter, "number of FIFO buffer errors" },
    { "network_interfaces_iframe", prometheus::MetricType::Counter, "number of packet framing errors" },
    { "network_interfaces_obytes", prometheus::MetricType::Counter,
        "total number of bytes of data transmitted by the interface" },
    { "network_interfaces_opackets", prometheus::MetricType::Counter,
        "The total number of packets of data transmitted by the interface" },
    { "network_interfaces_oerrs", prometheus::MetricType::Counter,
        "total number of transmitted errors detected by the device driver" },
    { "network_interfaces_odrop", prometheus::MetricType::Counter, "total number of packets dropped by the interface" },
    { "network_interfaces_ofifo", prometheus::MetricType::Counter, "total number of FIFO buffer errors" },
    { "network_interfaces_ocolls", prometheus::MetricType::Counter, "number of collisions detected on the interface" },
    { "network_interfaces_ocarrier", prometheus::MetricType::Counter,
        "number of carrier losses detected by the device driver" },
};

static const prometheus_kpi_descriptor g_prometheus_kpi_cpu[] = {
    // baremetal : cpu
    { "stat_user", prometheus::MetricType::Counter, "time spent in user mode" },
    { "stat_nice", prometheus::MetricType::Counter, "Time spent in user mode with low priority (nice)" },
    { "stat_sys", prometheus::MetricType::Counter, "Time spent in system mode" },
    { "stat_idle", prometheus::MetricType::Counter, "Time spent in the idle task" },
    { "stat_iowait", prometheus::MetricType::Counter, "Time waiting for I/O to complete" },
    { "stat_hardirq", prometheus::MetricType::Counter, "Time servicing interrupts" },
    { "stat_softirq", prometheus::MetricType::Counter, "Time servicing softirqs" },
    { "stat_steal", prometheus::MetricType::Counter,
        "Stolen time, which is the time spent in other operating systems when running in a virtualized environment " },
    { "stat_guest", prometheus::MetricType::Counter, "Time spent running a virtual CPU for guest operating systems" },
    { "stat_guestnice", prometheus::MetricType::Counter,
...
static const prometheus_kpi_descriptor g_prometheus_kpi_proc_meminfo[] = {
    ...
    { "proc_meminfo_MemAvailable", prometheus::MetricType::Counter,
        "An estimate of how much memory is available for starting new applications" },
    { "proc_meminfo_MemFree", prometheus::MetricType::Counter,
    ...
    { "proc_meminfo_Cached", prometheus::MetricType::Counter,
    ...
    { "proc_meminfo_Active_file", prometheus::MetricType::Counter,
        "The amount of file cache memory, in kibibytes, that is in active use" },
    { "proc_meminfo_Inactive_file", prometheus::MetricType::Counter,
    ...
    { "proc_meminfo_Dirty", prometheus::MetricType::Counter,
    ...
    { "proc_meminfo_WritebackTmp", prometheus::MetricType::Counter,
    ...
    { "proc_meminfo_CommitLimit", prometheus::MetricType::Counter,
        ...
        "(vm.overcommit_ratio)" },
    { "proc_meminfo_Committed_AS", prometheus::MetricType::Counter,
...
static const prometheus_kpi_descriptor g_prometheus_kpi_proc_vmstat[] = {
    ...
    { "proc_vmstat_nr_active_anon", prometheus::MetricType::Counter, "proc_vmstat_nr_active_anon" },
    { "proc_vmstat_nr_active_file", prometheus::MetricType::Counter, "proc_vmstat_nr_active_file" },
    { "proc_vmstat_nr_alloc_batch", prometheus::MetricType::Counter, "proc_vmstat_nr_alloc_batch" },
    { "proc_vmstat_nr_anon_pages", prometheus::MetricType::Counter, "proc_vmstat_nr_anon_pages" },
    ...
    { "proc_vmstat_nr_dirty", prometheus::MetricType::Counter, "proc_vmstat_nr_dirty" },
    { "proc_vmstat_nr_dirty_background_threshold", prometheus::MetricType::Counter,
        "proc_vmstat_nr_dirty_background_threshold" },
    { "proc_vmstat_nr_dirty_threshold", prometheus::MetricType::Counter, "proc_vmstat_nr_dirty_threshold" },
    { "proc_vmstat_nr_file_pages", prometheus::MetricType::Counter, "proc_vmstat_nr_file_pages" },
    { "proc_vmstat_nr_free_cma", prometheus::MetricType::Counter, "proc_vmstat_nr_free_cma" },
    { "proc_vmstat_nr_free_pages", prometheus::MetricType::Counter, "proc_vmstat_nr_free_pages" },
    { "proc_vmstat_nr_inactive_anon", prometheus::MetricType::Counter, "proc_vmstat_nr_inactive_anon" },
    { "proc_vmstat_nr_inactive_file", prometheus::MetricType::Counter, "proc_vmstat_nr_inactive_file" },
    ...
    { "proc_vmstat_nr_kernel_stack", prometheus::MetricType::Counter, "proc_vmstat_nr_kernel_stack" },
    { "proc_vmstat_nr_mapped", prometheus::MetricType::Counter, "proc_vmstat_nr_mapped" },
    { "proc_vmstat_nr_mlock", prometheus::MetricType::Counter, "proc_vmstat_nr_mlock" },
    { "proc_vmstat_nr_page_table_pages", prometheus::MetricType::Counter, "proc_vmstat_nr_page_table_pages" },
    { "proc_vmstat_nr_shmem", prometheus::MetricType::Counter, "proc_vmstat_nr_shmem" },
    { "proc_vmstat_nr_slab_reclaimable", prometheus::MetricType::Counter, "proc_vmstat_nr_slab_reclaimable" },
    { "proc_vmstat_nr_slab_unreclaimable", prometheus::MetricType::Counter, "proc_vmstat_nr_slab_unreclaimable" },
    ...
    { "proc_vmstat_nr_writeback", prometheus::MetricType::Counter, "proc_vmstat_nr_writeback" },
