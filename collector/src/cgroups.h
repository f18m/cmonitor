...
static const prometheus_kpi_descriptor g_prometheus_kpi_cgroup_cpu[] = {
    // cgroup : cpu
    { "cgroup_cpuacct_stats_user", prometheus::MetricType::Counter, "CPU time consumed by tasks in user mode" },
    { "cgroup_cpuacct_stats_sys", prometheus::MetricType::Counter,
        "CPU time consumed by tasks in system (kernel) mode" },
    { "cgroup_cpuacct_stats_nr_periods", prometheus::MetricType::Counter,
        "Number of periods that any thread in the cgroup was runnable" },
    { "cgroup_cpuacct_stats_nr_throttled", prometheus::MetricType::Counter,
        "Number of runnable periods in which the application used its entire quota and was throttled" },
    { "cgroup_cpuacct_stats_throttled_time", prometheus::MetricType::Counter,
...
static const prometheus_kpi_descriptor g_prometheus_kpi_cgroup_network[] = {
    // cgroup : network
    { "cgroup_network_ibytes", prometheus::MetricType::Counter,
        "Total number of bytes of data received by the interface" },
    { "cgroup_network_ipackets", prometheus::MetricType::Counter,
        "Total number of packets of data received by the interface" },
    { "cgroup_network_ierrs", prometheus::MetricType::Counter,
        "Total number of receive errors detected by the device driver" },
    { "cgroup_network_idrop", prometheus::MetricType::Counter, "Total number of packets dropped by the device driver" },
    { "cgroup_network_ififo", prometheus::MetricType::Counter, "Total number of FIFO buffer errors" },
    { "cgroup_network_iframe", prometheus::MetricType::Counter, "Total number of packet framing errors" },
    { "cgroup_network_obytes", prometheus::MetricType::Counter,
        "Total number of bytes of data transmitted by the interface" },
    { "cgroup_network_opackets", prometheus::MetricType::Counter,
        "Total number of packets of data transmitted by the interface" },
    { "cgroup_network_oerrs", prometheus::MetricType::Counter,
        "Total number of transmitted errors detected by the device driver" },
    { "cgroup_network_odrop", prometheus::MetricType::Counter, "Total number of packets dropped by the interface" },
    { "cgroup_network_ofifo", prometheus::MetricType::Counter, "Total number of FIFO buffer errors" },
    { "cgroup_network_ocolls", prometheus::MetricType::Counter,
        "Total number of collisions detected on the interface" },
    { "cgroup_network_ocarrier", prometheus::MetricType::Counter,
...
static const prometheus_kpi_descriptor g_prometheus_kpi_cgroup_processes[] = {
    ...
    // cgroup : task/threads
    { "cgroup_tasks_last", prometheus::MetricType::Counter, "CPU number last executed on" },
    { "cgroup_tasks_usr", prometheus::MetricType::Counter,
        "Amount of time that this process has been scheduled in user mode, measured in clock ticks" },
    { "cgroup_tasks_sys", prometheus::MetricType::Counter,
    ...
    { "cgroup_tasks_minor_fault", prometheus::MetricType::Counter,
        "The number of minor faults the process has made which have not required loading a memory page from disk" },
    { "cgroup_tasks_major_fault", prometheus::MetricType::Counter,
    ...
    { "cgroup_tasks_rchar", prometheus::MetricType::Counter,
        "The number of bytes which this task has caused to be read from storage" },
    { "cgroup_tasks_wchar", prometheus::MetricType::Counter,
        "The number of bytes which this task has caused, or shall cause to be written to disk" },
    { "cgroup_tasks_read_bytes", prometheus::MetricType::Counter, "Bytes read" },
    { "cgroup_tasks_write_bytes", prometheus::MetricType::Counter, "Bytes written" },
