...
static const prometheus_kpi_descriptor prometheus_kpi_cgroup_memory[] = {
    ...
    { "cgroup_memory_stats_stat_active_file", KPI_TYPE::Gauge,
    ...
    { "cgroup_memory_stats_stat_cache", KPI_TYPE::Gauge, "Number of bytes of page cache memory" },
    { "cgroup_memory_stats_stat_mapped_file", KPI_TYPE::Gauge,
        "Number of bytes of mapped file (includes tmpfs/shmem)" },
    { "cgroup_memory_stats_stat_pgfault", KPI_TYPE::Gauge, "Total number of page faults incurred" },
    { "cgroup_memory_stats_stat_pgmajfault", KPI_TYPE::Gauge, "Number of major page faults incurred" },
    { "cgroup_memory_stats_stat_pgpgin", KPI_TYPE::Gauge, "Number of charging events to the memory cgroup" },
    { "cgroup_memory_stats_stat_pgpgout", KPI_TYPE::Gauge, "Number of uncharging events to the memory cgroup" },
    ...
    { "cgroup_memory_stats_stat_rss_huge", KPI_TYPE::Gauge, "Number of bytes of anonymous transparent hugepages" },
...
static const prometheus_kpi_descriptor prometheus_kpi_cgroup_network[] = {
    ...
    { "cgroup_network_ififo", KPI_TYPE::Gauge, "Total number of FIFO buffer errors" },
    { "cgroup_network_iframe", KPI_TYPE::Gauge, "Total number of packet framing errors" },
    { "cgroup_network_obytes", KPI_TYPE::Gauge, "Total number of bytes of data transmitted by the interface" },
    { "cgroup_network_opackets", KPI_TYPE::Gauge, "Total number of packets of data transmitted by the interface" },
    ...
    { "cgroup_network_ocolls", KPI_TYPE::Gauge, "Total number of collisions detected on the interface" },
    { "cgroup_network_ocarrier", KPI_TYPE::Gauge, "Total number of carrier losses detected by the device driver" },
